        ...
        {rides.map((ride) => (
          <div key={ride.id} style={card}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "6px 16px", fontSize: "14px", color: "#cbd5e1", marginBottom: "16px" }}>
              <p style={{ margin: 0 }}>🕒 {new Date(ride.departureTime).toLocaleString()}</p>
              <p style={{ margin: 0 }}>
              ...
              <div style={{ padding: "24px" }}>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: "10px", marginBottom: "20px" }}>
                  {[
                    ...
                    { icon: "🕒", label: "Departure",      value: new Date(r.departureTime).toLocaleString("en-PK", { dateStyle: "medium", timeStyle: "short" }) },
