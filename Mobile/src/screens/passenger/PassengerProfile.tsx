...
const SUPPORT_WHATSAPP_NUMBER = "923001234567"; // TODO: replace with real Saffar support number
const WHATSAPP_PRESET_MESSAGE = "Hi Saffar Support, I need help with my account.";
...
export default function PassengerProfile() {
  ...
  const saveProfile = useCallback(async () => {
    ...
    try {
      ...
      setSaveError(typeof msg === "string" ? msg : "Failed to save.");
    } finally {
      setSaving(false);
    }
  }, [form]);
  ...
  const openWhatsApp = useCallback(async () => {
    // wa.me works as a universal link: opens the app if installed, else the
    // mobile web fallback. Try the app-scheme first for a snappier handoff.
    ...
    try {
      ...
      try {
        ...
        Alert.alert("Unable to open", "Couldn't open WhatsApp.");
      }
    }
  }, []);
    ...
    <View style={{ flex: 1, backgroundColor: COLORS.bg }}>
      ...
      <Pressable
        ...
        style={({ pressed }) => ({
          position: "absolute",
          right: 18,
          bottom: insets.bottom + 90, // sit above the tab bar
          width: 58,
          height: 58,
          borderRadius: 29,
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  Email and CNIC are locked. Contact support to update verified
                  information.
                </Text>
              </View>
...
function StatusPill({ status }: { status: string | null | undefined }) {
  ...
  return (
    ...
    >
      <MaterialIcons name={palette.icon} size={12} color={palette.fg} />
      <Text
        style={{
          color: palette.fg,
          fontSize: 11,
